require(["config"],function(){
	require(["jquery","template","load","right","autoplay"], function($, template) {
		...
		$.extend(Index.prototype, {
			...
			addListener(){
//				$(".list-category").on("mouseenter",".category-name",$.proxy(this.enterCategoryList,this));
//				$(".list-category").on("mouseleave",".category-name",$.proxy(this.leaveCategoryList,this));
				let html="";
				let len=0;
